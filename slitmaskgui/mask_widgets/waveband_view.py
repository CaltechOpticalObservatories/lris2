...
class WavelengthView(QWidget):
    ...
    def __init__(self):
        ...
        self.passband_title.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        top_layout.addWidget(self.passband_title)
    ...
    def disconnect_signalers(self):
        try:
            ...
            print("disconnect for waveband view failed")
    ...
    def make_line_between_text_and_bar(self, bar_positions, name_positions,edge_of_name) -> list:
        ...
        the corresponding passbands in the middle
        
        Args: 
            bar_positions: positions of passbands formatted like [(x_bar,height,star_name),...]
    ...
    def update_angstrom_text(self,passband):
        ...
        self.passband_title.setText(text)

    def calculate_bar_length(self,passband,which_grism):
        """
        calculates how long the passband will be for the selected grism

        Args:
            passband: the range of the passband in nm
